...
- Monthly or annual subscription fees on the v2-2026 ladder (Starter → Business)
- Additional credit purchases / top-ups
- Add-on purchases (channels, voice, seats, crawler, etc.)
...
4. **Target growing teams** — Business tier = highest recurring commission

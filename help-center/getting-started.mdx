...
icon: rocket
---
## Welcome to Rannah رنّة's Help Center!
> **Why do you use Rannah رنّة, & why shouldn't I create something similar or my own RAG solution?**

> **Special thanks to [Magicmark.ai](https://magicmark.ai/) for the help in building this help center!**
### Pros of using Rannah رنّة
...
> **Without Rannah رنّة you'll need to handle:**
...
> **Luckily, Rannah رنّة has all of this and more to try out right now for free! so you can focus on building your agent and not worry about the rest.** 
...
- **Rannah رنّة is perfect for an agency or a business of any size that dont wan't to deal with all the hassle of setting a lot of infrastructure and wants the best practices in their hands to make their support/marketing channels AI first with powerful AI agents that they can setup in minutes and go live tonight.**

### Cons of using Rannah رنّة
- Now all the previous sounds good until you need to make really advanced integrations/custom UI (I dunno like if you want to add a 3D speaking model as the chat avatar for some reason 😂), **then you'll start hitting limits with Rannah رنّة, but these limits are only for anything related to the front-end (Web widget/Dashboard) (we are working on improving customizablity tremendously especially for developers)**, that said; our whole backend is controllable via the [REST API](/api-reference/v3/intro) (you can easily create, edit agents, adjust prompts, add/delete KB docs from the API).
- **Rannah رنّة is not a good fit for you if you're looking to build a completely custom front-end for your agent where CSS edits are not enough, or if you're looking to build a custom RAG solution where you control everything, do devops & control every bit yourself and generally have more time/resources to hire developers.**
...
If you're looking to create make/zapier/API integration please check out our API reference: [API Reference](/api-reference/introduction)
...
If you're looking to setup Github Pages: [help-center/gh-pages-setup](/deploy/rannah-widget)
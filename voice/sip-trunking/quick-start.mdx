...
<AccordionGroup>
  <Accordion title="How many phone numbers can I add?">
    On **v2-2026**: **2** on Business. Extra Twilio number slots are \$3/mo. Voice / SIP starts on Business (or the Voice / SIP add-ons).
  </Accordion>
  ...
  <Accordion title="Is there a limit on concurrent calls?">
    Yes — Rannah رنّة limits concurrent calls by plan (**3** on Business; extra lines \$5/mo), and your SIP provider may have its own cap.
  </Accordion>
</AccordionGroup>

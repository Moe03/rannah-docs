...
<AccordionGroup>
  ...
  <Accordion title="How many concurrent calls can it handle?">
    The server auto-scales to handle your call volume. Concurrent calls on
    **v2-2026** are **3** (Business), **10** (White Label), or **25** (White
    Label Elite). Extra lines are $5/mo. Custom / dedicated capacity is
    available via sales.
  </Accordion>

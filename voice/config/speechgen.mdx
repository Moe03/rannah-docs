...
description: "Learn how to configure speech generation in Rannah رنّة Voice Suite."
icon: "waveform"
---

Learn how to configure **Speech Generation** in the Rannah رنّة Voice Suite. Use providers like **ElevenLabs** to generate human-like speech responses with customizable options for tone, background noise, and punctuation breaks.
...
![Speech Provider Dropdown](/voice/assets/new-speechgen-select.png)

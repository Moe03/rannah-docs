...
For every provider there will be different configurations and pricing, we'll charge the credits worth of whatever the provider costs if you're using Rannah رنّة's own API keys, you can use yours by adding them from the credentials tab.

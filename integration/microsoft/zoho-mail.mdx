...
6. Review the permissions requested:
   ...
   - Manage your mailbox
7. Click **Accept** to grant access to Rannah رنّة.
...
After connecting the account, Zoho also needs a webhook URL so it can notify Rannah رنّة the moment a new email arrives.

1. Stay on the **Zoho Mail** integration card inside Rannah رنّة and click **Manage**.
...
4. Create (or edit) an **Outgoing Webhook**:
   ...
   - **Webhook URL**: Paste the URL you copied from Rannah رنّة.
5. Click **Save**.

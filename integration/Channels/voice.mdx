---
title: "Connect Vapi"
description: "Connect your Vapi account to your AI agent on Rannah رنّة."
icon: "microphone" 
---

# Vapi Voice Service Integration

Welcome to the Rannah رنّة Vapi Voice Service integration guide! This document will help you quickly connect and configure the Vapi Voice Service with Rannah رنّة, allowing you to leverage voice interactions powered by AI.
...
## Why Integrate Vapi with Rannah رنّة?
...
By integrating Vapi with Rannah رنّة, you can:
...
<Card title="Need Help Setting Up?" icon="question" href="https://rannah.io">
...
1. An active [Rannah رنّة](https://rannah.io/) account with permissions to integrate third-party services.
2. Access to a [Vapi Voice Service](https://dashboard.vapi.ai/) account.

---

## Steps to Integrate Vapi with Rannah رنّة
...
### Step 2: Configure Rannah رنّة for Vapi Integration

1. Log in to your [Rannah رنّة](https://rannah.io/) account.
...
### Step 4: Configure Voice Setup for the Agent on Rannah رنّة

1. On your [Rannah رنّة](https://rannah.io/) platform, select the **agent** you want to integrate with Vapi.
...
- This tutorial video provides a comprehensive guide on connecting VAPI to your Rannah رنّة agent:
...
- **API Key errors:** Double-check that you entered the correct **Public** and **Private API Keys** in both the Vapi and Rannah رنّة platforms. Ensure there are no spaces or missing characters

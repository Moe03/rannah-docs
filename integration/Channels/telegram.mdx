...
description: "Learn how to integrate your Telegram bot with Rannah رنّة for seamless AI-powered conversations"
icon: "telegram"
---
...
<Note>
  ...
  - Access to your Rannah رنّة dashboard - Administrative privileges for bot
  creation
</Note>
...
### 2. Connecting to Rannah رنّة

Now that you have your Telegram bot, let's connect it to your Rannah رنّة dashboard.
...
<Steps>
  ...
  <Step title="Check Dashboard">
    Verify that messages appear in your Rannah رنّة dashboard under the
...
<Card title="Troubleshooting">
  ...
  in BotFather - Confirm your Rannah رنّة subscription is active
</Card>

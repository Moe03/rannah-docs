...
description: "Connect your Discord server to your AI agent on Rannah رنّة."
icon: "discord"
---

# Discord Integration

Welcome to the Rannah رنّة Discord integration guide! This document will help you quickly connect and configure Discord with Rannah رنّة, enabling seamless communication between your Discord server and AI agent.

## Why Integrate Discord with Rannah رنّة?
...
By integrating Discord with Rannah رنّة, you can:
...
1. An active [Rannah رنّة](https://rannah.io/) account with appropriate permissions
2. Administrative access to the Discord server where you want to add the bot

---

## Steps to Integrate Discord with Rannah رنّة
...
<Step title="Set Up Discord Webhook">
  ...
  6. Return to Rannah رنّة dashboard
...
<Step title="Configure Channel ID">
  ...
  4. Paste the ID in the **Channel ID** field on Rannah رنّة

...
description: 'Easily connect your WhatsApp Business account to your AI agent on Rannah رنّة using the new embedded sign-up method.'
icon: 'whatsapp'
---

### Introduction

This guide walks you through the new embedded sign-up method to connect your WhatsApp Business account to your AI agent on Rannah رنّة. This method simplifies the process by allowing you to verify and connect a phone number not previously linked to WhatsApp directly through our platform.

### Prerequisites

- A phone number **not** currently connected to WhatsApp.
- Access to the Rannah رنّة platform.
- A Facebook account to associate with your WhatsApp Business account.

### Step 1: Access the Channels Section

1. In to your Rannah رنّة Agent.
2. Navigate to the **Channels** section in the topbar and choose whatsapp integration.

![Access Channels Section](/images/nm-whatsapp/16.png)
...
2. Click the **Connect** button to link your account with Rannah رنّة.
...
**Congratulations!** Your WhatsApp Business account is now successfully connected to your Rannah رنّة AI agent.
...
- [Rannah رنّة Help Center](/Support/contact)
...
<Note>
  ...
  App. Follow the steps above to quickly integrate WhatsApp with your Rannah رنّة agent.
</Note>

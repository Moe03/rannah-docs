---
title: 'Shopify'
description: 'Integrate your Rannah رنّة Agent into your Shopify store.'
icon: shopify
---
...
<Steps>
  <Step title="Access Your Rannah رنّة Dashboard">
    ...
    <Info>
        You'll find an agents unique ID on its dedicated card in the `Agents` tab or in the URL from the agent designer ex. https://rannah.io/app/eu/agents/gib2no07kqdy1f2m/overview 
    </Info>
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Autostart Chat">
    Add `autostart: true,` to the `RANNAH_CONFIG` object to have the widget open automatically when a user visits your store.
  </Accordion>

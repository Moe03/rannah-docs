---
title: 'Squarespace'
description: 'Integrate your Rannah رنّة Agent into your Squarespace site.'
icon: squarespace
---
...
<Steps>
  <Step title="Access Your Rannah رنّة Dashboard">
    Log in to your Rannah رنّة account and navigate to your agent's settings. Note down your unique agent ID.

    <Info>
        You'll find an agent's unique ID on its dedicated card in the `Agents` tab or in the URL from the agent designer ex. https://rannah.io/app/eu/agents/gib2no07kqdy1f2m/overview 
    </Info>
  </Step>
...
If you encounter issues with your Rannah رنّة Agent widget integration:

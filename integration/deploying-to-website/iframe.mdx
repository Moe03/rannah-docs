---
title: "Iframe"
description: "Explore the versatile applications of iframes for Rannah رنّة AI agents"
icon: frame
---

Iframes introduce a whole new range of use cases for Rannah رنّة agent, allowing for seamless integration into various platforms and websites. This method offers flexibility and reduces potential conflicts with existing scripts or stylesheets.
...
<AccordionGroup>
  ...
  <Accordion title="SaaS Add-on" icon="rocket">
    Offer your Rannah رنّة Agent as a value-added feature in your SaaS platform.
    ...
    <Card title="Embeddable Pricing" icon="money-bill-trend-up" href="/help-center/introduction">

Learn more about turning your agent into a branded client-facing offer with Rannah رنّة's embeddable pricing flow.
...
**To integrate your Rannah رنّة Agent using an iframe, follow these steps:**

<Steps>
  <Step title="Get Your Agent's Iframe URL">
    1. Log in to your Rannah رنّة Dashboard
...
<Step title="Choose Your Integration Method">
  ...
  <Step title="Add the Iframe Code">
    ...
    <Warning>
      Replace `YOUR_AGENT_ID` with your actual Rannah رنّة Agent ID.
    </Warning>
...
Iframe integration opens up a world of possibilities for Rannah رنّة. By thinking creatively and leveraging the flexibility of iframes, you can create unique, engaging, and highly functional AI-powered experiences across various platforms and use cases.

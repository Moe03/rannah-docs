...
#### **check our example prompts:**
    <CardGroup>
  <Card title="TechTalk" icon="microphone-lines" href="techtalk"></Card>
  <Card title="Bakemate" icon="cake-candles" href="bakemate"></Card>
</CardGroup>

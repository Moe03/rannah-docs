...
![](/images/design-and-setup-hero.jpg)
...
<CardGroup cols={2}>
  <Card title="Language Code:" icon="language">
    Rannah رنّة uses [ISO 639-1 language codes](https://en.wikipedia.org/wiki/List_of_ISO_639_language_codes) to set the language, this means your widget can have literally **any** language. \*\*Codes are primarily used in the developer API.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card icon="">
    <video controls autoPlay muted loop playsInline src="/images/changing_language.mp4" style={{ width: '400px', borderRadius: '0.8rem' }} />
  </Card>
</CardGroup>
...
<img
  src="/images/shots_button_layout_cropped.png"
  width="500"
/>
...
overflow: 'hidden'}}
  ...
  <Tab title="Horizontal">
    ...
    <video autoPlay muted loop playsInline src="/images/Horizontal_buttons_video.mp4" style={{ width: '300px', borderRadius: '0.8rem' }} />
  </Tab>
  <Tab title="In footer">
    Buttons In footer:

    <video autoPlay muted loop playsInline style={{ width: '300px', borderRadius: '0.8rem' }} src="/images/buttons_in_footer.mp4" />
  </Tab>
</Tabs>
...
<AccordionGroup>
  <Accordion title="Launch Avatar Image">
    ...
    <video autoPlay muted loop playsInline style={{ width: '600px', borderRadius: '0.8rem' }} src="/images/launch_avatar_video.mp4" />
  </Accordion>

  <Accordion title="Header Image">
    Chat icon in the top left corner of the agent.

    <video autoPlay muted loop playsInline style={{ width: '300px', borderRadius: '0.8rem' }} src="/images/header_image_video.mp4" />
  </Accordion>

  <Accordion title="Banner Image">
    Display image at the top of the chat.

    <video autoPlay muted loop playsInline style={{ width: '300px', borderRadius: '0.8rem' }} src="/images/banner_image_video.mp4" />
  </Accordion>

  <Accordion title="Chat Avatar">
    Main image for the agent's chat messages.

    <video autoPlay muted loop playsInline style={{ width: '300px', borderRadius: '0.8rem' }} src="/images/chat_avatar_video.mp4" />
  </Accordion>
  ...
  <Accordion title="Background Chat Image">
    ...
    <img
      src="/images/Vertical_buttons.png"
      width="300"
      style={{
borderRadius: '12px',
overflow: 'hidden'}}
...
<Tip>
  If youre struggling to find your brands primary color. We recommend dowloading the chrome/edge plugin [ColorPick Eyedropper](https://chromewebstore.google.com/detail/colorpick-eyedropper/ohcpnigalekghcmgcdcenkpelffpdolg) to easily find your preferred color from your website color.
</Tip>
...
It's essential to know how the agent behaves and looks before launching on your website or letting a client test it. Rannah رنّة has two options for testing, right from the agent designer:

<CardGroup cols={2}>
  <Card title="Prototype:" icon="cubes">
    1. Share the prototype link with stakeholders to test a demo of the agent.

    ![](/images/prototype_screen_shots.png)
  </Card>
  ...
  <Card title="Demo:" icon="presentation-screen">
    ...
    <img
      src="/images/demo_screenshot_shots.png"
      width="600"
    />
  </Card>
</CardGroup>

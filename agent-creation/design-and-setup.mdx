...
<Tabs>
  <Tab title="Vertical">
    ...
    <img src="/images/buttons-layout.jpg"  width="300" style={{
    borderRadius: '12px',
    overflow: 'hidden'}}></img>
...
<Card title="Tools" icon="gear"></Card>
<Card title="Prompt guide" icon="text"></Card>

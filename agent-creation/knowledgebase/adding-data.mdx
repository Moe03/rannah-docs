...
## Adding Data to the Knowledge Base
    ...
    Rannah رنّة offers multiple methods to populate your knowledge base with data: 
...
Rannah رنّة offers multiple methods to populate your knowledge base with data. Follow the steps below for each method:

...
<CardGroup cols={2}>
  ...
  <Card title="Augmented Generation" icon="wand-magic-sparkles">
    ...
    using one of the LLMs available in Rannah رنّة.
  </Card>
</CardGroup>
...
<Accordion title="Example RAG Architecture">
  <img
    ...
    src="https://i.imgur.com/qoytE43.png"
    width="600"
...
<img class="rounded-md" src="/images/knowledgebase_interface_shots2.png" width="600"></img>{' '}

> The knoweldge base interface in Rannah رنّة
...
<Note>
  Version history works for both Rannah رنّة/VG agents and Voiceflow/VF agents. History starts building from the point a document is saved with the feature enabled, so older documents may not have earlier revisions recorded.
</Note>
...
<Card
  ...
  icon="gear"
  href="/agent-creation/knowledgebase/adjusting-kb-settings"
></Card>
<Card
  title="Structuring KB documents"
  icon="file"
  href="/agent-creation/knowledgebase/structuring-kb-documents"
></Card>

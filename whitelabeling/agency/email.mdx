...
<Info>
Enter only the domain (e.g., yourdomain.com) without any protocol (https://). For example, we added **rannah.io**
</Info>
  </Step>
...
<Note>
  Advanced email-related capabilities may continue to expand over time. If you need help with your current email setup or rollout, contact [support@rannah.io](mailto:support@rannah.io).
</Note>
...
The Agency Overview tab is where you establish your agency's identity within the Rannah رنّة platform. This information will be prominently displayed in your client dashboard, creating a cohesive and branded experience for your customers.
...
<CodeGroup>
```markdown Example
Create awesome AI Agents with [Rannah رنّة](https://rannah.io)
```
</CodeGroup>
  </Step>

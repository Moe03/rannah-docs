...
<img src="/images/custom-tabs/custom-tab-review.png" alt="Custom Tabs Creator Interface" width="700" class="rounded-md" />

## Creating Custom Tabs
<Steps>
  <Step title="Access Custom Tabs">
    Navigate to the `Agency` from left nav then click `Custom Tabs` section.
     <img src="/images/custom-tabs/custom-tab.png" alt="Custom Tab Page"/>
  </Step>
  <Step title="Add New Tab">
    ...
    <img src="/images/custom-tabs/edit-custom-tab.png" alt="Edit Custom Tab"/>
  </Step>
...
<Step title="Configure Tab Settings">
    ...
    <img src="/images/custom-tabs/add-config.png" alt="Edit Custom Tab"/>
</Step>
  ...
  <Step title="Choose Content Type">
    ...
    <img src="/images/custom-tabs/html-content.png" alt="Custom Tabs Code interface" width="700" class="rounded-md" />
    ...
    <img src="/images/custom-tabs/iframe-content.png" alt="Custom Tabs Code interface" width="700" class="rounded-md" />
  </Step>

  <Step title="Preview and Save">
    Use the `Preview` button to check your tab's appearance, then click `Save`.
     <img src="/images/custom-tabs/save.png" alt="save" width="700" class="rounded-md" />
  </Step>
</Steps>
...
<Step title="Add New Client">
    Navigate to `Clients` from the left navigation, click on `+ New Client`, then enter the client name.
     <img src="/images/custom-tabs/client.png" alt="Client page"/>
      <img src="/images/custom-tabs/add-client.png" alt="Add new client"/>
</Step>
<Step title="Assign Agent to Client">
    Drag the agent into the client you created, then click `Manage`.
     <img src="/images/custom-tabs/assign-agent.png" alt="Assign agent to client"/>
</Step>
<Step title="Add User">
    Click `Add User` and enter the user's name and email.
     <img src="/images/custom-tabs/add-user.png" alt="Add User"/>
    <img src="/images/custom-tabs/user-data.png" alt="Add User Data"/>

</Step>
<Step title="Enable Custom Tab">
    Enable the `Custom Tab` switch for the tab you created.
     <img src="/images/custom-tabs/enable-custom-tab.png" alt="Enable custom tab"/>
</Step>
<Step title="Access Whitelabel Link">
    Navigate to `Agency` → `Domain`, then click on the whitelabel URL.
     <img src="/images/custom-tabs/agency-url.png" alt="Whitelabel URL"/>
</Step>
<Step title="Login to Whitelabel">
    Log in with the email of the user you created that has access to the `Custom Tab`.
     <img src="/images/custom-tabs/login.png" alt="Login to whitelabel"/>
</Step>
<Step title="View Custom Tab">
    Finally, you will see the `Custom Tab` on your dashboard.
     <img src="/images/custom-tabs/custom-tab-added.png" alt="Custom tab added to dashboard"/>
</Step>
</Steps>

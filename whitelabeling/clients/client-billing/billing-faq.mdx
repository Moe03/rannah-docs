...
Get answers to the most common questions about billing and credits in Rannah رنّة. This guide explains pricing, transactions, and how to manage billing effectively.

<Callout type="info">
  All financial transactions are securely processed via Stripe. Rannah رنّة
...
1. Rannah رنّة deducts the **base credit price** for each purchased credit.
...
### 8. **What is Rannah رنّة's service fee?**

Rannah رنّة charges a **5% fee** on the agency owner’s margin after deducting the base credit price.
...
### 10. **Does Rannah رنّة save credit card information?**

No, Rannah رنّة does not save any credit card details. All payment information is securely handled by **Stripe**.

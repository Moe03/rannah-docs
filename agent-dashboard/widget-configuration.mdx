      ...
      <AccordionGroup>
        <Accordion title="API Key Management" icon="key">
          <div className="space-y-4">
            ...
            <Info>
            **API Documentation**: Use your secret key with our [REST API](/Support/contact) for programmatic agent management, conversation handling, and data integration.
            </Info>
          </div>
        </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="API Integration" icon="plug" href="/Support/contact">

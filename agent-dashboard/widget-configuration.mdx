    ...
    <AccordionGroup>
      ...
      <Accordion title="NPM Package Integration" icon="box">
        <div className="space-y-4">
          ...
          pnpm install @rannah-labs/web-sdk@latest
          
          # Or with npm
          npm install @rannah-labs/web-sdk@latest
          ```
          ...
          (function () {
            window.RANNAH_CONFIG = {
              ...
              region: "na",
              render: "bottom-right",
              stylesheets: ["https://rannah.io/vg_live_build/styles.css"],
            };
            var s = document.createElement("script");
            s.src = "https://rannah.io/vg_live_build/vg_bundle.js";
            s.defer = true;
  ...
  <Accordion title="Widget Not Loading" icon="circle-x">
    <Steps>
      <Step title="Verify Configuration">
        Check that `RANNAH_CONFIG` contains valid agent ID and region settings
      </Step>
  ...
  <Accordion title="File & Image Upload Issues" icon="paperclip">
    <Steps>
      ...
      <Step title="Check region">
        Ensure `RANNAH_CONFIG.region` matches your account region (`eu` or `na`). Uploads post to the regional vg-docker API.
      </Step>

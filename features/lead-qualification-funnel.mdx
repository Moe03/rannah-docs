...
<Steps>
  <Step title="Agency Account Created" icon="building">
    You must have an active agency account. See [What is an Agency](/help-center/introduction) for setup instructions.
  </Step>
  <Step title="Theme Configured" icon="palette">
    Configure your brand colors and logo in agency settings. See [Theme Configuration](/help-center/introduction).
  ...
  <Step title="Custom Domain Setup" icon="globe">
    Configure your custom domain for branded conversation links. See [Custom Domain Setup](/help-center/introduction).
  ...
  <Step title="Email Domain Configured" icon="envelope">
    Set up your custom email domain for branded sender addresses. See [Email Configuration](/help-center/introduction).
...
<Steps>
  ...
  <Step title="Select or Create Client" icon="building-user">
    Choose an existing client organization or create a new one. See [Managing Organizations](/help-center/introduction).
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Conversation Link Uses rannah.io">
    ...
    See [Custom Domain Setup](/help-center/introduction) for configuration steps.
  </Accordion>
</AccordionGroup>

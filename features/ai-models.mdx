...
Rannah رنّة AI provides access to a wide range of **state-of-the-art** AI models, ensuring that your agents are always equipped with the best and newest models on the market.

<Note>
  On the **v2-2026** catalog, models are gated by plan **tier** (Tier 4 on Free → Tier 1 flagship on Business+). See live rates and unlocks on [Pricing](/Pricing/overview) and the [Credits](/Pricing/credits) docs.
</Note>

<Tip>
  As soon as **new models** are released, the Rannah رنّة AI team promptly updates

...
const response = await fetch('https://eu-gcp-api.vg-stuff.com/v3/prompts', {
  method: 'POST',
  headers: {
...
const updateResponse = await fetch('https://eu-gcp-api.vg-stuff.com/v3/prompts/prompt_id', {
  method: 'PUT',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY',
    'Content-Type': 'application/json'

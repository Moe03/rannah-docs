...
<Note>
Live handoff is operated from the Rannah رنّة dashboard when you are logged in and available to manage conversations.
</Note>
...
<Steps>
  <Step title="Assign the agent to an organization">
    The agent must be assigned to an organization so it can be operated from the dashboard.
  </Step>
  <Step title="Ensure a user is available">
    Make sure a user with access to the dashboard is available to handle incoming handoff requests.
  </Step>
</Steps>

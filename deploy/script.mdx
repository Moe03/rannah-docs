...
# Script
You can deploy Rannah رنّة with a script.
...
```bash
<script src="https://unpkg.com/@rannah-labs/react-voice-orb@latest/dist/voice-orb.min.js"></script>
```
...
<script>
  ...
  window.VoiceOrb.init({
    agentId: "YOUR_AGENT_ID",   // Replace with your agentId from Rannah رنّة.

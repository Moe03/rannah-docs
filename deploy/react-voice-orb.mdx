...
The **@rannah-labs/react-voice-orb** package provides a React component that renders a voice orb widget. This component uses WebRTC for voice calls and WebGL for rendering the animated orb. It is designed for use in React applications and provides an easy-to-integrate solution.
...
- Navigate to the [Rannah رنّة Dashboard](https://rannah.io) and create an agent.
...
```bash
https://rannah.io/app/eu/agents/cj5lbhgMJHu4RLxmzM5Q/overview?showDebugger=true
```
...
<Note>Replace "agentId" and "region" with values from your Rannah رنّة Dashboard.</Note>
...
<Note>
  If you have a bug report please contact [support@rannah.io](mailto:support@rannah.io).
</Note>

### Resources

<CardGroup cols={2}>
  <Card title="NPM" icon="npm" href="https://www.npmjs.com/package/@rannah-labs/react-voice-orb">
    `@rannah-labs/react-voice-orb` on npm
  </Card>
  <Card title="Support" icon="envelope" href="mailto:support@rannah.io">
    Contact Rannah رنّة support
  </Card>
</CardGroup>

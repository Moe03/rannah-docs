---
title: 'Voice Calls'
description: 'Integrate Rannah رنّة voice calls using the @tixae-labs/web-sdk package.'
icon: 'microphone'
---

## Overview

The **@tixae-labs/web-sdk** package enables voice call functionality via WebRTC. It allows you to initialize a voice call session with an agent (identified by `agentId` and `region` from your [Rannah رنّة Dashboard](https://rannah.io) and provides event listeners to track call status.

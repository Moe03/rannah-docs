---
title: "FAQ"
description: "Welcome to the Frequently Asked Questions (FAQs) section of the Rannah رنّة documentation. Here, we’ve compiled the most common queries to help you get started and troubleshoot any issues you may encounter."
icon: comments
---

## General

### 1. What is Rannah رنّة?

<Card>
  Rannah رنّة is a platform that provides AI-powered chatbots and large
...
### 2. How do I create a Rannah رنّة agent?

<Tip>
  To create a Rannah رنّة agent, sign up on the Rannah رنّة platform and follow the
...
### 3. How do I manage my Rannah رنّة agent?

<Card>
  You can manage your Rannah رنّة agent through the Rannah رنّة dashboard, where you
...
### 4. What does "white-labeling" mean in Rannah رنّة?

<Note>
  White-labeling allows you to brand and customize the Rannah رنّة platform with
  your own branding (logos, color schemes, etc.). This enables you to offer
  chatbot services under your brand name while leveraging Rannah رنّة’s backend
  technology.
</Note>
...
### 5. How do I integrate WhatsApp with Rannah رنّة?
...
<Note>
  ...
  **Channels** section in the Rannah رنّة dashboard. 2. Choose the Meta channel
...
- **Email us**: [support@rannah.io](mailto:support@rannah.io)
- **In-app support**: Open **System → Support** in the dashboard sidebar to chat with Rannah رنّة's support agent.
- **Join our Discord**: [**Join Discord**](mailto:support@rannah.io)

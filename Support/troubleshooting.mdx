...
description: "Quick solutions to common issues you may encounter while using Rannah رنّة."
icon: "wrench"
---
...
<Card>
  **Solutions**: - Ensure that your **Voiceflow API Key** and **Voiceflow
  ...
  Ensure that you are using the latest Voiceflow template from your Rannah رنّة dashboard.
</Card>
...
<Warning>
  **Cause**: - Incorrect WhatsApp Business ID. - Incorrect Webhook URL. -
  Expired or invalid tokens. - Configuration errors in the Rannah رنّة
  dashboard.
</Warning>
...
2. **Refresh or Renew Access Tokens**:
   ...
   - Generate a new token and update it in the **Channels** section of your Rannah رنّة dashboard.
...
<Card>
  Open **System → Support** in the dashboard sidebar (`/app/[region]/support`) to chat with Rannah رنّة's support agent. Your workspace context is shared automatically.
</Card>
...
<Card>
  ...
  **[support@rannah.io](mailto:support@rannah.io)**
</Card>
...
<Card>
  ...
  Discord**](mailto:support@rannah.io)
</Card>
